...
<nav class="navbar navbar-light bg-light mb-5" style="background-color: #286efa !important;">
  <div class="container-fluid">
    <a class="navbar-brand" href="https://blogangular-c7858.web.app" style="color:#fff;">
      <img src="assets/images/perfil.jpeg" alt="" width="50" height="50" class="d-inline-block align-text-top">
      Canal WebDeveloper
    </a>
...
<?php } ?>
  ...
  <div class="row text-center">
    <div class="col-md-12 p-md-4" style="background-color: #f9f9f9;">
      ...
      <p style="font-weight:600; font-size: 30px;"><strong>No olvides</strong></p>
      <img src="assets/images/youtube.gif" class="card-img-top" alt="perfil" style="width:40%">
    </div>
  </div>
